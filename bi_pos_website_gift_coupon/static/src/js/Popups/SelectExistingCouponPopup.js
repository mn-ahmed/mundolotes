...
odoo.define('bi_pos_website_gift_coupon.SelectExistingCouponPopup', function(require){
	'use strict';
			...
			if(order){
				...
				await self.rpc({
					...
					if(output.length > 0)
					{
						...
						if( is_categ && (categ_ids.length > 0 || product_ids.length > 0)){
