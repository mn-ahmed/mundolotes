...
class PosOrderReport(models.Model):
    ...
    actual_average = fields.Float(string='Actual Average', group_operator="avg")
        ...
        return """
            SELECT
                ...
                CASE
                    ...
                    ELSE ( SUM(ROUND((l.qty * l.price_unit) * (100 - l.discount) / 100 / CASE COALESCE(s.currency_rate, 0) WHEN 0 THEN 1.0 ELSE s.currency_rate END, cu.decimal_places)) / SUM(l.qty) )::decimal
                END AS actual_average
        """
